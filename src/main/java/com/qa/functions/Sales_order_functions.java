...
public class Sales_order_functions extends TestBase {
	...
	public void so_customer_details(String cus_searchbox,String item_searchbox,String quantity,String amount,String location,String rate,String terms,String discount_item,String contact,String fax_no,String shipping_cost,String sales_rep,String shipping_carrier, String shipping_tax_code,String payment_method,String shipping_method,ExtentTest test) throws InterruptedException
	{
	...
	public void validations(String cus_searchbox,String item_searchbox2, String quantity2, String amount2, String location2, ExtentTest test, ExtentReports report) throws InterruptedException
	{
		String [] items=new String[3];
		for(int i=0;i<3;i++)
		{
